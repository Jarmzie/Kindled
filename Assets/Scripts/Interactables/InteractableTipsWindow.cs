        ...
        switch (hub.myTutState)
        {
            ...
            case HubStateManager.TutorialState.GoodToGo:
                tempDialogue.GetComponent<Dialogue>().RunDialogue(SQUID_NAME, new string[] { 
                    "I might have plenty of things to share but I honestly feel like I've shared enough for now.",
                    "How about you go and try yourself in the dungeon."
                });
                hub.myTutState = HubStateManager.TutorialState.Why;
                break;
            case HubStateManager.TutorialState.Controls:
                tempDialogue.GetComponent<Dialogue>().RunDialogue(SQUID_NAME, new string[] {
                    "Hey, how about we talk about controls?",
            ...
            case HubStateManager.TutorialState.Why:
                tempDialogue.GetComponent<Dialogue>().RunDialogue(SQUID_NAME, new string[] {
                    "Hey, how about we talk about why you're here?",
            ...
            case HubStateManager.TutorialState.TheDungeon:
                tempDialogue.GetComponent<Dialogue>().RunDialogue(SQUID_NAME, new string[] {
                    "Hey, how about we talk about the dungeon?",
            ...
            case HubStateManager.TutorialState.TheHub:
                tempDialogue.GetComponent<Dialogue>().RunDialogue(SQUID_NAME, new string[] {
                    "Hey, how about we talk about the Oil Rig?",
            ...
            case HubStateManager.TutorialState.Lanterns:
                ...
                hub.myTutState = HubStateManager.TutorialState.Baterns;
                break;
            case HubStateManager.TutorialState.Baterns:
                tempDialogue.GetComponent<Dialogue>().RunDialogue(SQUID_NAME, new string[] {
